...
<main id="printableArea">
    ...
    <form id="myForm" method="post" action="insertApp" enctype="multipart/form-data" style="padding: 20px;">
        ...
        <input type="hidden" id="furloughDetailsCode" name="furloughDetailsCode" value="${furloughDetailsCode}">
        ...
        <h3><%out.print(formId);%> 사용 정보</h3>
	        <div>
			    <label for="furloughStartDate" style="width: 120px; text-align: center; font-weight: bold;">시작일 </label>
			    <input style="margin-left:100px; width: 200px; text-align: center; height: 30px;" type="date" id="furloughStartDate" name="furloughStartDate" onchange="updateDay()" required><br><br>
			</div>
			<div>
			    <label for="furloughEndDate" style="width: 120px; text-align: center; font-weight: bold;">종료일 </label>
			    <input style="margin-left:100px; width: 200px; text-align: center; height: 30px;" type="date" id="furloughEndDate" name="furloughEndDate" onchange="updateDay()" required><br><br>
			</div>
			<div>
			    <label for="usagePeriod" style="width: 120px; text-align: center; font-weight: bold;">사용일 </label>
			    <input style="margin-left:100px; width: 200px; text-align: center; height: 30px;" type="number" id="usagePeriod" name="furloughServiceData" placeholder="사용 일수를 입력하세요" required /><br><br>
			</div>
	
		<div>
	        <p>
	        <h4>사유</h4>
			<textarea class="text-box" id="furloughCnt" style="border: 1px solid #BDBDBD; padding: 10px; margin-bottom: 20px; width: 650px; height: 200px; resize: none;" name="furloughCnt" placeholder="사유를 입력하세요"></textarea>
