...
<main id="printableArea">
    ...
    <form action="updateApp" id="expForm" method="post" enctype="multipart/form-data" style="padding: 20px">
        ...
        <table>
            ...
            <tr>
				...
				<td style="text-align: center; width: 80px;">
                    <button type="button" class="btn btn-outline-econdary" data-bs-toggle="modal" data-bs-target="#addressModal" onclick="setModalType('referrer')">참조</button>
			    </td>
            </tr>
            <tr>
        ...
        <table style="border: 1px solid #BDBDBD; padding: 10px; margin-bottom: 20px; margin-right: 25px;">
            ...
            <tr>
	        	...
	        	<c:forEach var="appCost" items="${appCostList}" varStatus="status">
              	<td>
                    <input type="text" name="costDetailsCnt" value="${appCost.costDetailsCnt}" style="text-align: center; width : 400px;" />
               	</td>
               	<td>
                    <input type="number" name="costAmount" value="${appCost.costAmount}" style="text-align: center; width : 100px;" />
               	</td>
               	</c:forEach>
            </tr>
    	</table>
		<br>
	   	...
	   	<div>
			...
			<div style="margin-bottom: 20px;">
			    <input type="file" name="imageAttachment" class="file-upload" onchange="updateFileName(this)">
			    <span id="fileName" style="margin-left: 10px;"></span>
			    <a href="/se/appDownLoad?imageAttachment=${approvalDto.imageAttachment}" style="text-decoration: none; margin-left: 10px;" id="downloadLink">${approvalDto.imageAttachment}</a>
			</div>
		</div>
