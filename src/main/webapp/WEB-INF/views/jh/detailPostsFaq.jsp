...
<main>
	...
	<div class="button-container">
        <c:if test="${emp.admin == 150 || emp.admin == 170}">
            <button class="btn btn-outline-primary" style="margin-right: 15px;" onclick="location.href='/jh/updatePostsFaq?postId=${posts.postId}'">수정</button>
            <button class="btn btn-outline-danger" style="margin-right: 15px;" onclick="confirmDelete('${posts.postId}')">삭제</button>
        </c:if>
